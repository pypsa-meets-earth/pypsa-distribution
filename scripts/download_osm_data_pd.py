...
- ``data/osm/out``:  Prepared power data as .geojson and .csv files per country- ``resources/osm/raw``: Prepared and per type (e.g. cable/lines) aggregated power data as .geojson and .csv files
"""
import logging
import os
import shutil
...
from _helpers_dist import configure_logging
from config_osm_data_pd import iso_to_geofk_dict
...
if __name__ == "__main__":
    if "snakemake" not in globals():
        ...
        snakemake = mock_snakemake("download_osm_data_pd")
    ...
    eo.get_osm_data(
        ...
        feature_list=[
            ...
            # "church", "kingdom_hall", "monastery", "mosque", "presbitery", "religious", "shrine",
